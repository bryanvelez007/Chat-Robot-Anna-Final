...
const speech = new SpeechSynthesisUtterance();
    ...
    if (message.includes('novia')) {
        speech.text = "Me gustas…. pero solo como amigo.";
    }
    if (message.includes('estuvo') && message.includes('dia')) {
        speech.text = "Super duper";
    }

    if (message.includes('casada')) {
        speech.text = "Estoy felizmente soltera.";
    }

    if (message.includes('soy tu padre')) {
    ...
    if (message.includes('creador') || message.includes('creadores') || message.includes('dueños') || message.includes('fundador')) {
    ...
    if (!message.includes("papaterra") || !message.includes("carlos ")) {
